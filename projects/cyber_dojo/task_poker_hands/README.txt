...
queen, king, ace (denoted 2, 3, 4, 5, 6, 7, 8, 9, T, J, Q, K, A).
...
Pair:
2 of the 5 cards in the hand have the same value. Hands which both contain a pair are
...
Input: Black: 2H 3D 5S 9C 8D White: 2C 3H 4S 8C 7H
...
-------------------------
Note:
    The original third example from cyber-dojo, I think it was wrong, so I have edited it.
    In their example the hands should tie, because the high card of each hand is: K, which value is 13.
